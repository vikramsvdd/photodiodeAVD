...
% correspondingly their power vector is 1,2,3,4,
% this gets converted to a voltage vector after photodiode stage, assuming
% Mst=100, Voexp = 1e-2,2e-2,3e-2,4e-2, but see the reality below
if(miv==100)
    Voexp=[8.2068,11.6329,14.2619,16.4782]; % modelled according to non linear M v P
%characteristics,Mstinitial=100
elseif(miv==80)
    Voexp=[7.9724,11.3076,13.8668,16.0243];%Mstinitial=80
elseif(miv==60)
    Voexp=[8.1940,11.6331,14.2721,16.4969];%Mstinitial=60
elseif(miv==40)
    Voexp=[8.1403,11.5793,14.2183,16.4432];%Mstinitial=40
elseif(miv==20)
    Voexp=[8.0372,11.4994,14.1566,16.3970];%Mstinitial=20
end
In=[666,1332,1998,2664];
tc=[0,0,0,0];
