...
if(miv==100)
    Voexp=[0.2045,0.7647,1.1066,1.3691]; % modelled according to non linear M v P
%characteristics,Mstinitial=100
elseif(miv==80)
    Voexp=[0.1869,0.7292,1.0615,1.3169];%Mstinitial=80
elseif(miv==60)
    Voexp=[0.1747,0.7276,1.0694,1.3324];%Mstinitial=60
elseif(miv==40)
    Voexp=[0.1451,0.6816,1.0209,1.2827];%Mstinitial=40
elseif(miv==20)
    Voexp=[0.0924,0.5675,0.8961,1.1537];%Mstinitial=20
end
In=[0.66,6.66,13.32,19.98];
tc=[0,0,0,0];
